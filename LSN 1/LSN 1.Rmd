...
\item[b.] Create a contingency table and mosaic plot to summarize the response and explanatory variables. Does the plot suggest an association exists? Explain. Clearly indicate the response and explanatory variable in your response.
