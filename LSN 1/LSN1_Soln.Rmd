...
*In future work we could create statistical models that allow us to 1) adjust for categorical variables with more than two levels and 2) evaluate the impact of potential confounders like age, socioeconomic status, and political party affiliation .*
