...
*One potential confounding variable is race. Sentiments about law enforcement use of FRT and educational attainment may vary by race*.
...
*For future work we could create statistical models that allow us to 1) evaluate the impact of potential confounders like socioeconomic status and political party affiliation and 2) adjust for categorical variables with more than two levels.*
