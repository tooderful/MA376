...
t.test(male$Income, female$Income, alternative='greater', #var.equal = T,
       mu=0, conf.level=0.95, data = wage.dat)
``` 
...
c. Are the results for the theory-based approach consistent with those from the 3S Strategy? `r colorize("*1) The results are consistent. We have strong evidence against the null hypothesis.*", "blue")`
