...
Use boxplots to plot the conditional distributions of income for males and females. Consider whether there appears to be an association between the two variables.
...
c) Is there evidence of a statistically significant difference in the mean income for males and females? 
